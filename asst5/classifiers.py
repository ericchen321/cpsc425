...
def nearest_neighbor_classify(train_image_feats, train_labels_classnames, test_image_feats, n_neighbors=7):
    ...
    Parameters
        ...
        train_labels_classnames: is an N x l cell array, where each entry is a string 
    ...
    Returns
        -------
        knn: fitted model
    	predicted_labels: an M x l cell array, where each row is a one-hot vector 
    ...
    predicted_labels_classnames = knn.predict(test_image_feats) # (M, l)
